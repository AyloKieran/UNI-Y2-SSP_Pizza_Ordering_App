        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    ...
                    @else
                    <x-slot name="trigger">
                        <a href="{{ route('login') }}" class="text-gray-500 hover:text-gray-700 hover:underline">Log
                            in</a>
                        <x-slot name="content">
                        </x-slot>
                        <a href="{{ route('register') }}" class="text-gray-500 hover:text-gray-700 hover:underline pl-2">Register</a>
                        <x-slot name="content">
                        </x-slot>
                    </x-slot>
